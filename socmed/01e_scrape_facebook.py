...
Input : input/variable_keywords.csv
        input/Facebook/www.facebook.com_cookies.txt  (Netscape format)
...
HOW TO GET COOKIES:
  ...
  4. Save as: input/Facebook/www.facebook.com_cookies.txt
  5. In .env: FB_COOKIES_FILE=input/Facebook/www.facebook.com_cookies.txt
...
INPUT_KW = ROOT / "input" / "variable_keywords.csv"
FB_DIR   = ROOT / "output" / "socmed" / "facebook"
OUTPUT   = FB_DIR / "facebook_raw.csv"
FB_DIR.mkdir(parents=True, exist_ok=True)

_ck_env      = os.getenv("FB_COOKIES_FILE", "input/Facebook/www.facebook.com_cookies.txt")
