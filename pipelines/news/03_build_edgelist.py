...
INPUT  = ROOT / "data" / "processed" / "news" / "extracted_raw.jsonl"
OUTDIR = ROOT / "data" / "processed" / "news"
...
REVIEWED_FILE = ROOT / "data" / "raw" / "news" / "flat_statements_reviewed.csv"
...
if REVIEWED_FILE.exists():
    ...
    CORRECTIONS_FILE = ROOT / "data" / "raw" / "news" / "manual_corrections.csv"
